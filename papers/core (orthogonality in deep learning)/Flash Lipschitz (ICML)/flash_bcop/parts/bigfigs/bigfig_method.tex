\begin{figure*}[ht]
    \centering
    %\includegraphics[width=0.95\textwidth]{flash_bcop/figs/illustrations/fig_method_2.png}
    %\includegraphics[width=0.95\textwidth]{flash_bcop/figs/illustrations/fig_method_3b.png}
    \includegraphics[width=0.95\textwidth]{flash_bcop/figs/illustrations/method_v4.png}
