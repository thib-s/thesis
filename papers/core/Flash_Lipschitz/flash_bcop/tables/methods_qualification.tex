...
%         BCOP &\cite{li_preventing_2019} & \cmark & $k$ & \cmark & \cmark & $\capprox$ & \xmark & \xmark & \xmark \\
%         % --- ORTHOGONIUM version
%          \includegraphics[height=2ex]{flash_bcop/figs/illustrations/orthogonium_logo_b.png} AOC & & \cmark & $k$ & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark \\

%         SLL &\cite{araujo_unified_2023} & \xmark & composed & \cmark & \xmark & \xmark & \xmark & \xmark  & \xmark\\
%          \includegraphics[height=2ex]{flash_bcop/figs/illustrations/orthogonium_logo_b.png} SLL & & \cmark & composed & \cmark & \cmark & \cmark & \cmark & \cmark  & \cmark\\

%         AOL &\cite{prach_almost-orthogonal_2022} & \xmark & $k$ & \cmark & \cmark & \cmark & \xmark & \xmark & \xmark \\
%         \includegraphics[height=2ex]{flash_bcop/figs/illustrations/orthogonium_logo_b.png} AOL & & \cmark & $k$ & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark \\

%         SOC &\cite{singla_skew_2021} & \cmark & $k + (n\frac{k}{2})$ & \cmark & $\capprox$ & $\capprox$ & \xmark & \xmark & \xmark \\
%          \includegraphics[height=2ex]{flash_bcop/figs/illustrations/orthogonium_logo_b.png} SOC & & \cmark & $k + (n\frac{k}{2})$ & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark \\
%         \hline
%     \end{tabular}
%     \label{tab:big_picture}
% \end{table*}
